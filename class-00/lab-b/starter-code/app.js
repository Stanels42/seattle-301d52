...
// In this first example the 'this' is scoped to the 'joe' object and returns the object itself
// 2. What is "this" when joe.scopeArrow() is invoked?
//In the arrow function the 'this' is now scoped to the window itself and no longer to the object
// 3. Explain why "this" is different when an arrow function is used.
// The use of an arrow function unbinds the 'this' call and it instead has a *global* scope. **I say global but the scope is really EVERYTHING all the way upto the window iself and nolonger where it was bound to.
